  ...
  <div class="app-container">
    ...
    <div class="box-body">
      ...
      >
        ...
        <el-table-column prop="gid" label="gid" align="center"></el-table-column>
        <el-table-column prop="coin" label="金币" align="center"></el-table-column>
        <el-table-column prop="box" label="保险箱" align="center"></el-table-column>
        <el-table-column prop="point" label="钻石" align="center"></el-table-column>
        <el-table-column prop="sum" label="总数" align="center"></el-table-column>
      </el-table>
    </div>
...
<script>
import { pwcoinlog } from "@/api/dailydata";
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      pwcoinlog(this.params).then(res => {

  ...
  <div class="app-container">
    ...
    <div class="box-body">
      ...
      >
        ...
        <!--        <el-table-column prop="totalreg" label="注册人数(限制uuid)" align="center"></el-table-column>-->
        <el-table-column prop="loginp" label=" 新注册用户/新注册（排重设备）/新注册活跃" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.allreg || msg}}&nbsp;/&nbsp;{{scope.row.totalreg || msg}}&nbsp;/&nbsp;{{scope.row.regactive || msg }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="regactive" label="不排重设备的登录用户数/登录用户（排重设备）/登录人次/活跃人数" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.loginall || msg }}&nbsp;/&nbsp;{{scope.row.loginp || msg }}&nbsp;/&nbsp;{{scope.row.loginnum || msg }}&nbsp;/&nbsp;{{scope.row.activenum || msg}}</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
  import {dailyuser} from "@/api/dailydata";
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        dailyuser(this.params).then(res => {

...
*pagesize,currentPage*pagesize)"
            style="width: 100%"
          >
            <el-table-column prop="cdate" label="日期" align="center" width="100"></el-table-column>
            ...
            <el-table-column prop="max_online" label="最高在线/机器人最高在线" align="center" width="180">
              <template slot-scope="scope">
                <span>{{scope.row.max_online}}&nbsp;/&nbsp;{{scope.row.max_online_robot}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="recharge_num" label="充值人数" align="center" width="50"></el-table-column>
            <el-table-column prop="recharge_total" label="客户端收入" align="center" width="70"></el-table-column>
          </el-table>
        </el-card>
      </el-col>
...
*pagesize,currentPage*pagesize)"
          ...
          >
            <el-table-column prop="cdate" label="日期" align="center" width="100"></el-table-column>
            <!-- <el-table-column align="center" label="人局/当前房间数量">
              <template slot-scope="scope">
                <span>{{scope.row.roomNum || 0}}&nbsp;/&nbsp;{{scope.row.curRoomNum}}</span>
              </template>
            </el-table-column> -->
            <el-table-column align="center" label="用户数量/当前用户数量">
              <template slot-scope="scope">
                <span>{{scope.row.userNum || 0}}&nbsp;/&nbsp;{{scope.row.curUserNum}}</span>
              </template>
            </el-table-column>
            <el-table-column align="center" label="Tpt人局/当前Tpt房间数量">
              <template slot-scope="scope">
                <span>{{scope.row.tptRoomNum || 0}}&nbsp;/&nbsp;{{scope.row.curTptRoomNum}}</span>
              </template>
            </el-table-column>
            <el-table-column align="center" label="Tpt用户数量/当前Tpt用户数量">
              <template slot-scope="scope">
                <span>{{scope.row.tptUserNum || 0}}&nbsp;/&nbsp;{{scope.row.curTptUserNum}}</span>
              </template>
            </el-table-column>
            <el-table-column align="center" label="德州人局/当前德州房间">
              <template slot-scope="scope">
                <span>{{scope.row.texasRoomNum || 0}}&nbsp;/&nbsp;{{scope.row.curTexasRoomNum}}</span>
              </template>
            </el-table-column>
            <el-table-column align="center" label="德州用户数量/当前德州用户房间">
              <template slot-scope="scope">
                <span>{{scope.row.texasUserNum || 0}}&nbsp;/&nbsp;{{scope.row.curTexasUserNum}}</span>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
